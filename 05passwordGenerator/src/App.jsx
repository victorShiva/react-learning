...
function App() {
  ...
  const copyPasswardToClipboard = useCallback(() => {
    ...
    passwardRef.current?.setSelectionRange(0, 12)
  ...
  return (
    <>
      <div className='w-full bg-gray-700 max-w-lg mx-auto shadow-md rounded-lg px-4 py-6 my-8 text-orange-500 text-xl'
      >
